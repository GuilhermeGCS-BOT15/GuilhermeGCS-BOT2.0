...
exports.bug = () => {
	return`*O problema foi relatado ao nabuto, Relatórios falsos ou confusos não serão respondidos.*`
}
...
*「 PARABÉNS 」*
  ...
  ♡ۣۜۜ፝͜͜͡͡✿➤ Número : ${sender.split("@")[0]}
  ♡ۣۜۜ፝͜͜͡͡✿➤ Xp : ${getLevelingXp(sender)}
  ♡ۣۜۜ፝͜͜͡͡✿➤ Limite :  +3
  ♡ۣۜۜ፝͜͜͡͡✿➤ Classificação :  ${role}
  ♡ۣۜۜ፝͜͜͡͡✿➤ Nível : ${getLevel} ⊱ ${getLevelingLevel(sender)}
`}
